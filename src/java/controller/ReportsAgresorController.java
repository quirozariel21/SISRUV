...
@ManagedBean
@SessionScoped
public class ReportsAgresorController implements Serializable {
    ...
    public ReportsAgresorController() {
        seleccion_reporte = "";
    ...
    public void onChangeTipoReporte() {
        ...
        if ( fecha_ini.before(fecha_fin) ){
            if (seleccion_reporte.equals("Edad")) {
                listaView = view_reportDao.reporte_edad_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, host, usuario, pasword, dbname);
                
            }
            if (seleccion_reporte.equals("Estado Civil")) {
                listaView = view_reportDao.reporte_persona_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, host, usuario, pasword, dbname,"estado_civil","est_civil");
            }
            
            if (seleccion_reporte.equals("Nivel Instruccion")) {
                listaView = view_reportDao.reporte_persona_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, host, usuario, pasword, dbname,"nivel_instruccion","nivel_inst");
            }

            if (seleccion_reporte.equals("Parentesco")) {
                listaView = view_reportDao.reporte_vicagr_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, host, usuario, pasword, dbname,"relacion_agresor_victima","parentesco");
            }
            
            if (seleccion_reporte.equals("Violencias")) {
                    listaView = view_reportDao.reporte_tviolencia_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, host, usuario, pasword, dbname);
                }
            
            
            ///**********************************************************/
            if (seleccion_reporte.equals("Agresores por Sexo")) {
                listaView2 = view_reportDao.reporte_simple_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "sexo");                                   
            }
            
            if (seleccion_reporte.equals("Lugar de Nacimiento de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_agresor_nac(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin,"lugar_nac","lugar_nac");
            } 
            //Booleanos
            if (seleccion_reporte.equals("Municipio Donde Viven los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_booleanos_agresor(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "municipio");                                   
            }
            if (seleccion_reporte.equals("Nivel de Instruccion de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_agresor_instrucc(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin,"nivel_instruccion","nivel_inst");
            }
             if (seleccion_reporte.equals("Pertenencia a Pueblo Indigena Originario")) {
                listaView2 = view_reportDao.reporte_simple_booleanos_originario(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "etnia");                                   
            }
            if (seleccion_reporte.equals("Ocupacion de los Agresores")) {
                listaView2 = view_reportDao.reporte_agresor_ocupacion(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin,"ocupacion_principal","ocupacion");
            }
            if (seleccion_reporte.equals("Area Donde Viven los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_booleanos_area(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "area");                                   
            }
            
            if (seleccion_reporte.equals("Condicion de Actividad de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_booleanos_agresor_actividad(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "condicion_act");                                   
            }
            
           if (seleccion_reporte.equals("Ingreso Economico de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_agresor_ingr_economico(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin,"ingreso_economico","ingre_economico");
            }
           
            if (seleccion_reporte.equals("Pertenencia a Grupo LGTB")) {
                listaView2 = view_reportDao.reporte_simple_booleanos_agresor_lgtb(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin, "lgbti");                                   
            }
            if (seleccion_reporte.equals("Estado Civil de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_agresor_est_civil(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin,"estado_civil","est_civil");              
            }
            if (seleccion_reporte.equals("Edades de los Agresores")) {
                listaView2 = view_reportDao.reporte_simple_agresor_edad(obj.getUsuario().getCod_usuario(), fecha_ini, fecha_fin);                                   
            }
