 ...
 * @author e_mv
 */
@WebServlet(name = "Formulario", urlPatterns = {"/faces/Formulario"})
public class Formulario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("PARAMETROS DETAIL  : " + usuario_Tdatos.getDetalle_depto());
        parametros.put("detail_mun", usuario_Tdatos.getDetalle_muni());
       
                System.out.println("reports.Formulario.processRequest(): Detail_mun " + usuario_Tdatos.getDetalle_muni());

        parametros.put("detail_serv", usuario_Tdatos.getDetalle_serv());
                System.out.println("reports.Formulario.processRequest():  detail_ser " + usuario_Tdatos.getDetalle_serv());
        //parametros.put("detail_sub", usuario_Tdatos.getDetalle_subs()); //DETALLE SUB DESACTIVADO 
                System.out.println("detail_sub  : " + usuario_Tdatos.getDetalle_subs());

        parametros.put("cod_usuario", usuario_Tdatos.getUsuario().getCod_usuario());
                System.out.println("cod_usuario  : " + usuario_Tdatos.getUsuario().getCod_usuario());
        ...
        try {
            ...
            File reportFile = new File(sc.getRealPath("/WEB-INF/reports/formulario_va.jasper"));
